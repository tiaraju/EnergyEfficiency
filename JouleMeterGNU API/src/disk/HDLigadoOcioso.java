...
public class HDLigadoOcioso {
    ...
    public static void main(String[] args) throws Exception{
        ...
        //Para fazer as medições com o hd em uso, basta acrescentar aqui o stress -hdd, e ao final do programa finalizar a execução do stress, como no processador.
        analisaHDLigadoOcioso(5000);
        coletaDados(medicoes, new FileWriter(new File("/home/tiaraju/testes/HD/HD_Ligado_Ocioso.txt")));
        Runtime.getRuntime().exec("xset -display :0.0 dpms force on");
    }
    
    private static void analisaHDLigadoOcioso(int INTERVALO_DE_TEMPO) throws Exception {
        ...
        analisaHDLigadoOcioso(INTERVALO_DE_TEMPO);
        }
        else{
